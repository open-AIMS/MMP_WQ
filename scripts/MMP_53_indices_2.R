...
if ((alwaysExtract | !file.exists(paste0(INDICES_OUTPUT_PATH,"wq.alt2.idx.RData"))) &
    ...
    {
        ##QAQC figure
        p <- mmp__qaqc(wq.alt2.qaqc, level = 1, type = '2',
                       wq.units = wq.units,
                       wq.sites = wq.sites
                       )

        MMP__figure_export_dev(FIGURE_OUTPUT_PATH, fig_name_suffix = "wq_alt2_qaqc",
                                    Plot = p, units = "in",
                                    fig.width = 180/25.4, fig.height = 180/25.4, pt.size = 10)

        MMP__figure_quarto(CURRENT_STAGE, "calculate indices", FIGURE_OUTPUT_PATH,
                           Section = "QAQC", fig_name_suffix = "wq_alt2_qaqc",
                           label_suffix = "_2_qaqc", tabset_parent = "TABSET_2",
                           fig.caption = paste0("\nObserved ",as.numeric(reportYear),"/",as.numeric(reportYear)," water quality data associated with the alt2 (formulation 2) indices. Red and blue symbols represent dry and wet season samples. The purple band defines half and twice the annual guideline values.\n")) 
    ...
    {
        ##QAQC figure 1
        p <- mmp__qaqc(wq.alt2.qaqc1, level = 2, type = '2',
                       wq.units = wq.units,
                       wq.sites = wq.sites
                       )

        MMP__figure_export_dev(FIGURE_OUTPUT_PATH, fig_name_suffix = "wq_alt2_qaqc1",
                                    Plot = p, units = "in",
                                    fig.width = 180/25.4, fig.height = 180/25.4, pt.size = 10)

        MMP__figure_quarto(CURRENT_STAGE, "calculate indices", FIGURE_OUTPUT_PATH,
                           Section = "QAQC 1", fig_name_suffix = "wq_alt2_qaqc1",
                           label_suffix = "_2_qaqc1", tabset_parent = "TABSET_2",
                           fig.caption = paste0("\nSeasonal or annual ",as.numeric(reportYear),"/",as.numeric(reportYear)," water quality averages associated with the alt2 (formulation 0) indices. Red and blue symbols represent dry and wet season samples. The purple band defines half and twice the annual guideline values.\n")) 

        ## pdf(file = paste0(FIGURE_OUTPUT_PATH, 'wq_alt2_qaqc1.pdf'),
        ##     width=159.2/25.4, height=159.2/25.4,pointsize=12)
        ## print(p)
        ## dev.off()

        ## png(file = paste0(FIGURE_OUTPUT_PATH, 'wq_alt2_qaqc1.png'),
        ##     width=159.2, height=159.2,units='mm',res=300,pointsize=12)
        ## print(p)
        ## dev.off()
        ## png(file = paste0(FIGURE_OUTPUT_PATH, 'wq_alt2_qaqc1_large.png'),
        ##     width=159.2, height=159.2,units='mm',res=600,pointsize=12)
        ## print(p)
        ## dev.off()

        ## MMP_add_to_report_list(CURRENT_STAGE, "calculate indices",
        ##                        SUBSECTION_2_qaqc1 = structure(paste0("### QAQC 1\n"),
        ##                                                      parent = 'TABSET_2'),
        ##                        FIG_REF_2_qaqc1 = structure(paste0("\n::::: {#fig-2-qaqc1}\n"),
        ##                                            parent = 'SUBSECTION_2_qaqc1'),
        ##                        FIG_2_qaqc1 = structure(paste0("![](",FIGURE_OUTPUT_PATH,"wq_alt2_qaqc1.png)\n"),
        ##                                        parent = "FIG_REF_2_qaqc1"),
        ##                        FIG_CAP_2_qaqc1 = structure(paste0("\nSeasonal or annual ",as.numeric(reportYear),"/",as.numeric(reportYear)," water quality averages associated with the alt2 (formulation 2) indices. Red and blue symbols represent dry and wet season samples. The purple band defines half and twice the annual guideline values.\n"),
        ##                                            parent = 'FIG_REF_2_qaqc1'),
        ##                        FIG_REF_2_qaqc1_END = structure(paste0("\n::::: \n"),
        ##                                                parent = 'SUBSECTION_2_qaqc1')
        ##                        )
    ...
    {
        ##QAQC figure idx
        p <- mmp__qaqc(wq.alt2.qaqc2, level = 3, type = '2',
                       wq.units = wq.units,
                       wq.sites = wq.sites
                       )

        MMP__figure_export_dev(FIGURE_OUTPUT_PATH, fig_name_suffix = "wq_alt2_qaqc2",
                                    Plot = p, units = "in",
                                    fig.width = 180/25.4, fig.height = 180/25.4, pt.size = 10)

        MMP__figure_quarto(CURRENT_STAGE, "calculate indices", FIGURE_OUTPUT_PATH,
                           Section = "QAQC 2", fig_name_suffix = "wq_alt2_qaqc2",
                           label_suffix = "_2_qaqc2", tabset_parent = "TABSET_2",
                           fig.caption = paste0("\nSeasonal or annual ",as.numeric(reportYear),"/",as.numeric(reportYear)," water quality averages associated with the alt2 (formulation 0) indices. Red and blue symbols represent dry and wet season samples. The purple band defines half and twice the annual guideline values.\n")) 

        ## pdf(file = paste0(FIGURE_OUTPUT_PATH, 'wq_alt2_qaqc2.pdf'),
        ##     width=159.2/25.4, height=159.2/25.4, pointsize=10)
        ## print(p)
        ## dev.off()

        ## png(file = paste0(FIGURE_OUTPUT_PATH, 'wq_alt2_qaqc2.png'),
        ##     width=159.2, height=159.2,units='mm', res=300, pointsize=10)
        ## print(p)
        ## dev.off()
        ## png(file = paste0(FIGURE_OUTPUT_PATH, 'wq_alt2_qaqc2_large.png'),
        ##     width=159.2, height=159.2,units='mm', res=600, pointsize=10)
        ## print(p)
        ## dev.off()
        
        ## MMP_add_to_report_list(CURRENT_STAGE, "calculate indices",
        ##                        SUBSECTION_2_qaqc2 = structure(paste0("### QAQC 2\n"),
        ##                                                      parent = 'TABSET_2'),
        ##                        FIG_REF_2_qaqc2 = structure(paste0("\n::::: {#fig-2-qaqc2}\n"),
        ##                                            parent = 'SUBSECTION_2_qaqc2'),
        ##                        FIG_2_qaqc2 = structure(paste0("![](",FIGURE_OUTPUT_PATH,"wq_alt2_qaqc2.png)\n"),
        ##                                        parent = "FIG_REF_2_qaqc2"),
        ##                        FIG_CAP_2_qaqc2 = structure(paste0("\nSeasonal or annual ",as.numeric(reportYear),"/",as.numeric(reportYear)," water quality averages associated with the alt2 (formulation 2) indices. Red and blue symbols represent dry and wet season samples. The purple band defines half and twice the annual guideline values.\n"),
        ##                                            parent = 'FIG_REF_2_qaqc2'),
        ##                        FIG_REF_2_qaqc2_END = structure(paste0("\n::::: \n"),
        ##                                                parent = 'SUBSECTION_2_qaqc2')
        ##                        )
    },
    ...
    {
        ## Regional Worms
        p <- mmp__indicator_trends(wq.alt2.idx.region, level = 1, type = '2',
                       wq.units = wq.units,
                       wq.sites = wq.sites
                       )

        MMP__figure_export_dev(FIGURE_OUTPUT_PATH, fig_name_suffix = "wq_alt2_idx_region",
                               Plot = p + facet_grid(~Region,as.table=FALSE),
                               units = "in",
                               fig.width = 180/25.4, fig.height = 180*(2/7)/25.4, pt.size = 10)

        MMP__figure_quarto(CURRENT_STAGE, "calculate indices", FIGURE_OUTPUT_PATH,
                           Section = "Regional Index", fig_name_suffix = "wq_alt2_idx_region",
                           label_suffix = "_2_idx1", tabset_parent = "TABSET_2",
                           fig.caption = paste0("\nTemporal trends in the water quality index conditional on Region for the alt2 (formulation 2) indices.\n")) 

        MMP__figure_export_dev(FIGURE_OUTPUT_PATH, fig_name_suffix = "wq_alt2_idx_region1",
                               Plot = p + facet_wrap(~Region,as.table=FALSE,nrow=1,scales='free_y'),
                               units = "in",
                               fig.width = 8, fig.height = 2, pt.size = 10)

        MMP__figure_quarto(CURRENT_STAGE, "calculate indices", FIGURE_OUTPUT_PATH,
                           Section = "Regional Index alt.", fig_name_suffix = "wq_alt2_idx_region1",
                           label_suffix = "_2_idx1a", tabset_parent = "TABSET_2",
                           fig.caption = paste0("\nTemporal trends in the water quality index conditional on Region for the alt2 (formulation 2) indices.\n")) 

        ## pdf(file = paste0(FIGURE_OUTPUT_PATH, 'wq_alt2_idx_region.pdf'),
        ##     width=(159.2)/25.4, height=(159.2*(2/7))/25.4)
        ## print(p + facet_grid(~Region,as.table=FALSE))
        ## dev.off()

        ## pdf(file = paste0(FIGURE_OUTPUT_PATH, 'wq_alt2_idx_region1.pdf'),
        ##     width=7, height=2)
        ## print(p + facet_wrap(~Region,as.table=FALSE,nrow=1,scales='free_y'))
        ## dev.off()

        ## png(file = paste0(FIGURE_OUTPUT_PATH, 'wq_alt2_idx_region.png'),
        ##     width=(159.2), height=(159.2*(2/7)),units='mm',res=300, pointsize=10)
        ## print(p + facet_grid(~Region,as.table=FALSE))
        ## dev.off()

        ## png(file = paste0(FIGURE_OUTPUT_PATH, 'wq_alt2_idx_region1.png'),
        ##     width=7, height=2,units='in',res=300)
        ## print(p + facet_wrap(~Region,as.table=FALSE,nrow=1,scales='free_y'))
        ## dev.off()

        wq.alt2.idx.region <- p$data
        
        ## MMP_add_to_report_list(CURRENT_STAGE, "calculate indices",
        ##                        SUBSECTION_2_idx1 = structure(paste0("### Regional Index\n"),
        ##                                                      parent = 'TABSET_2'),
        ##                        FIG_REF_2_idx1 = structure(paste0("\n::::: {#fig-2-idx1}\n"),
        ##                                            parent = 'SUBSECTION_2_idx1'),
        ##                        FIG_2_qaqc1 = structure(paste0("![](",FIGURE_OUTPUT_PATH,"wq_alt2_idx_region.png)\n"),
        ##                                        parent = "FIG_REF_2_idx1"),
        ##                        FIG_CAP_2_idx1 = structure(paste0("\nTemporal trends in the water quality index conditional on Region for the alt2 (formulation 2) indices.\n"),
        ##                                            parent = 'FIG_REF_2_idx1'),
        ##                        FIG_REF_2_idx1_END = structure(paste0("\n::::: \n"),
        ##                                                parent = 'SUBSECTION_2_idx1'),

        ##                        FIG_REF_2_idx1b = structure(paste0("\n::::: {#fig-2-idx1b}\n"),
        ##                                            parent = 'SUBSECTION_2_idx1'),
        ##                        FIG_2_qaqc1b = structure(paste0("![](",FIGURE_OUTPUT_PATH,"wq_alt2_idx_region1.png)\n"),
        ##                                        parent = "FIG_REF_2_idx1b"),
        ##                        FIG_CAP_2_idx1b = structure(paste0("\nTemporal trends in the water quality index conditional on Region for the alt2 (formulation 2) indices.\n"),
        ##                                            parent = 'FIG_REF_2_idx1b'),
        ##                        FIG_REF_2_idx1b_END = structure(paste0("\n::::: \n"),
        ##                                                parent = 'SUBSECTION_2_idx1')
        ##                        )
    },
    ...
    {
        ## Subregion Worms
        p <- mmp__indicator_trends(wq.alt2.idx.subregion, level = 2, type = '2',
                       wq.units = wq.units,
                       wq.sites = wq.sites
                       )

        MMP__figure_export_dev(FIGURE_OUTPUT_PATH, fig_name_suffix = "wq_alt2_idx_subregion",
                               Plot = p + facet_grid(~Subregion,as.table=FALSE),
                               units = "in",
                               fig.width = 2*180/25.4, fig.height = 2*180*(2/10)/25.4, pt.size = 10)

        MMP__figure_quarto(CURRENT_STAGE, "calculate indices", FIGURE_OUTPUT_PATH,
                           Section = "Subregion Index", fig_name_suffix = "wq_alt2_idx_subregion",
                           label_suffix = "_2_idx2", tabset_parent = "TABSET_2",
                           fig.caption = paste0("\nTemporal trends in the water quality index conditional on Subregion for the alt2 (formulation 2) indices.\n")) 

        MMP__figure_export_dev(FIGURE_OUTPUT_PATH, fig_name_suffix = "wq_alt2_idx_subregion1",
        ...
        MMP__figure_quarto(CURRENT_STAGE, "calculate indices", FIGURE_OUTPUT_PATH,
                           Section = "Subregional Index alt.", fig_name_suffix = "wq_alt2_idx_subregion1",
                           label_suffix = "_2_idx2a", tabset_parent = "TABSET_2",
                           fig.caption = paste0("\nTemporal trends in the water quality index conditional on Subregion for the alt2 (formulation 2) indices.\n")) 

        ## pdf(file = paste0(FIGURE_OUTPUT_PATH, 'wq_alt2_idx_subregion.pdf'),
        ##     width=2*(159.2)/25.4, height=2*(159.2*(2/10))/25.4, pointsize=10)
        ## print(p + facet_grid(~Subregion,as.table=FALSE))
        ## dev.off()

        ## pdf(file = paste0(FIGURE_OUTPUT_PATH, 'wq_alt2_idx_subregion1.pdf'),
        ##     width=2*(159.2)/25.4, height=2*(159.2*(4/7))/25.4, pointsize=10)
        ## print(p +
        ##       facet_wrap(~Subregion,as.table=TRUE,nrow=2,scales='free'))                       
        ## dev.off()

        ## png(file = paste0(FIGURE_OUTPUT_PATH, 'wq_alt2_idx_subregion.png'),
        ##     width=2*(159.2), height=2*(159.2*(2/10)), pointsize=10, units='mm', res=300)
        ## print(p + facet_grid(~Subregion,as.table=FALSE))
        ## dev.off()

        ## png(file = paste0(FIGURE_OUTPUT_PATH, 'wq_alt2_idx_subregion1.png'),
        ##     width=2*(159.2), height=2*(159.2*(4/7)), pointsize=10,units='mm',res=300)
        ## print(p +
        ##       facet_wrap(~Subregion,as.table=TRUE,nrow=2,scales='free'))                       
        ## dev.off()

        wq.alt2.idx.subregion <- p$data

        ## MMP_add_to_report_list(CURRENT_STAGE, "calculate indices",
        ##                        SUBSECTION_2_idx2 = structure(paste0("### Subregional Index\n"),
        ##                                                      parent = 'TABSET_2'),
        ##                        FIG_REF_2_idx2 = structure(paste0("\n::::: {#fig-2-idx2}\n"),
        ##                                            parent = 'SUBSECTION_2_idx2'),
        ##                        FIG_2_qaqc2 = structure(paste0("![](",FIGURE_OUTPUT_PATH,"wq_alt2_idx_subregion.png)\n"),
        ##                                        parent = "FIG_REF_2_idx2"),
        ##                        FIG_CAP_2_idx1 = structure(paste0("\nTemporal trends in the water quality index conditional on Subregion for the alt2 (formulation 2) indices.\n"),
        ##                                            parent = 'FIG_REF_2_idx2'),
        ##                        FIG_REF_2_idx2_END = structure(paste0("\n::::: \n"),
        ##                                                parent = 'SUBSECTION_2_idx2'),

        ##                        FIG_REF_2_idx2b = structure(paste0("\n::::: {#fig-2-idx2b}\n"),
        ##                                            parent = 'SUBSECTION_2_idx2'),
        ##                        FIG_2_qaqc2b = structure(paste0("![](",FIGURE_OUTPUT_PATH,"wq_alt2_idx_subregion1.png)\n"),
        ##                                        parent = "FIG_REF_2_idx2b"),
        ##                        FIG_CAP_2_idx1b = structure(paste0("\nTemporal trends in the water quality index conditional on Subregion for the alt2 (formulation 2) indices.\n"),
        ##                                            parent = 'FIG_REF_2_idx2b'),
        ##                        FIG_REF_2_idx2b_END = structure(paste0("\n::::: \n"),
        ##                                                parent = 'SUBSECTION_2_idx2')
        ##                        )
    },
    ...
    {
        save(wq.alt2.idx,
             file = paste0(INDICES_OUTPUT_PATH, 'wq.alt2.idx.RData'))
        save(wq.alt2.idx.region,
             file = paste0(INDICES_OUTPUT_PATH, 'wq.alt2.idx.region.RData'))
        save(wq.alt2.idx.region,
             file = paste0(DATA_PATH, '/final/wq.alt2.idx.region.RData'))
        save(wq.alt2.idx.subregion,
             file = paste0(DATA_PATH, '/final/wq.alt2.idx.subregion.RData'))
        save(wq.alt2.idx.subregion,
             file = paste0(INDICES_OUTPUT_PATH, 'wq.alt2.idx.subregion.RData'))
    },
    LOG_FILE, item = CURRENT_ITEM, Category = 'Indices:', msg='Save alt2 indices', return=TRUE)
    ## ----end
